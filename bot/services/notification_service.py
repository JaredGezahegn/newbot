...
Your confession with ID {confession.id} has been approved and published to the channel!
...
Your confession with ID {confession.id} was not approved for publication.
